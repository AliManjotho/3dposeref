...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='MPI-INF-3DHP dataset converter')
    
    parser.add_argument('-p', '--path', default='', type=str, metavar='PATH', help='path to the processed MPI-INF-3DHP dataset')
    ...
    if args.path:
        print('Parsing MPI-INF-3DHP dataset from', args.path)
        output = {}
        output_2d = {}
        frame_mapping = {}
        ...
        metadata = suggest_metadata('mpiinf3dhp' + str(num_joints))
