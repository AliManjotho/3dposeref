...
mpiinf3dhp_skeleton = Skeleton(parents=[-1, 0, 1, 2, 3, 1, 5, 6, 0, 8, 9, 0, 11, 12, 1],
...
mpiinf3dhp_cameras_extrinsic_params = {
    'S1': [
        {
...
class MPI3DHPDataset(MocapDataset):
    def __init__(self, path):
        super().__init__(fps=60, skeleton=mpiinf3dhp_skeleton)
        
        self._cameras = copy.deepcopy(mpiinf3dhp_cameras_extrinsic_params)
