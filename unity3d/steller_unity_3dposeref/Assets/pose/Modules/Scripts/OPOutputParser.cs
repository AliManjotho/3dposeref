	...
	public static class OPOutputParser {
		...
		public static void ParseOutput(ref OPDatum datum, IntPtr[] ptrArray, int[] sizeArray, OutputType type){
			switch (type){
                ...
                case OutputType.PoseKeypoints3D: ParsePoseKeypoints3D(ref datum, ptrArray, sizeArray); break;
                ...
                case OutputType.FaceKeypoints3D: ParseFaceKeypoints3D(ref datum, ptrArray, sizeArray); break;
                ...
                case OutputType.Rotations: ParseRotations(ref datum, ptrArray, sizeArray); break;
                case OutputType.Image: ParseImage(ref datum, ptrArray, sizeArray); break;
				case OutputType.SkeletonImage: ParseSkeletonImage(ref datum, ptrArray, sizeArray); break;
        ...
        // Parse poseKeypoints3D
        public static void ParsePoseKeypoints3D(ref OPDatum datum, IntPtr[] ptrArray, int[] sizeArray)
        {
            Debug.AssertFormat(ptrArray.Length == 1, "PoseKeypoints array length invalid: " + ptrArray.Length);
            Debug.AssertFormat(sizeArray.Length == 3, "PoseKeypoints size length invalid: " + sizeArray.Length);
            int volume = 1;
            ...
            var valArray = new float[volume];
            Marshal.Copy(ptrArray[0], valArray, 0, volume);
            datum.poseKeypoints3D = new MultiArray<float>(valArray, sizeArray);
        }
        ...
        // Parse faceKeypoints3D
        public static void ParseFaceKeypoints3D(ref OPDatum datum, IntPtr[] ptrArray, int[] sizeArray)
        {
            Debug.AssertFormat(ptrArray.Length == 1, "FaceKeypoints3D array length invalid: " + ptrArray.Length);
            Debug.AssertFormat(sizeArray.Length == 3, "FaceKeypoints3D size length invalid: " + ptrArray.Length);
            int volume = 1;
            foreach (var i in sizeArray) { volume *= i; }
            if (volume == 0) return;
            ...
            var valArray = new float[volume];
            Marshal.Copy(ptrArray[0], valArray, 0, volume);
            datum.faceKeypoints3D = new MultiArray<float>(valArray, sizeArray);
        }
        ...
        // Parse rotations
        public static void ParseRotations(ref OPDatum datum, IntPtr[] ptrArray, int[] sizeArray)
        {
            Debug.AssertFormat(ptrArray.Length == 1, "Rotations array length invalid: " + ptrArray.Length);
            Debug.AssertFormat(sizeArray.Length == 3, "Rotations size length invalid: " + sizeArray.Length);
            int volume = 1;
            foreach (var i in sizeArray) { volume *= i; }
            if (volume == 0) return;
            ...
            var valArray = new float[volume];
            Marshal.Copy(ptrArray[0], valArray, 0, volume);
            datum.rotations = new MultiArray<float>(valArray, sizeArray);
        }
		...
		// Parse cvSkeletonOutputData
        public static void ParseSkeletonImage(ref OPDatum datum, IntPtr[] ptrArray, int[] sizeArray){
			Debug.AssertFormat(ptrArray.Length == 1, "Image array length invalid: " + ptrArray.Length);
			Debug.AssertFormat(sizeArray.Length == 3, "Image size length invalid: " + sizeArray.Length);
            int volume = 1;
            foreach(var i in sizeArray){ volume *= i; }
			...
			var valArray = new byte[volume];
			Marshal.Copy(ptrArray[0], valArray, 0, volume);
			datum.cvSkeletonOutputData = new MultiArray<byte>(valArray, sizeArray);
		}
