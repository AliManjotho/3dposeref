...
class Options:
    ...
    def _initial(self):
        ...
        self.parser.add_argument('--load',           type=str, default='/checkpoint/test/ckpt_best.pth.tar', help='path to load a pretrained checkpoint')

        self.parser.add_argument('--predict_14',     type=bool, default=False, help="predict 14 joints")
        self.parser.add_argument('--resume',         type=bool, default= True, help='resume to train')
        ...
        self.parser.add_argument('--sample',         type=bool,   default=True, help='Set to True for sampling.')
        ...
        self.parser.add_argument('--procrustes',     type=bool, default=False, help='use procrustes analysis at testing')
